...
<div id="views-bootstrap-carousel-<?php print $id ?>" class="<?php print $classes ?>" <?php print $attributes ?>>
  ...
  <?php if ($navigation): ?>
    <!-- Carousel navigation -->
    <a class="carousel-control left" data-target="#views-bootstrap-carousel-<?php print $id ?>" data-slide="prev" style="cursor: pointer;">
      <span class="icon-prev"></span>
    </a>
    <a class="carousel-control right" data-target="#views-bootstrap-carousel-<?php print $id ?>" data-slide="next" style="cursor: pointer;">
