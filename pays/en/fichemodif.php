...
if($_POST['pays']){
	...
	echo "<h3 style='color:green;'>Country index ".$_POST['pays']." modified.</h3>";
...
echo "Country : <select name='paysmodif' style='width:100px;'>";
...
echo "</select>";
echo "<input type='submit' value='Select this country'>";
echo "</form>";
...
echo "Country <input type='text' name='pays' size='50' value='".$pays."'>";
echo "<hr>";
...
if($_POST['paysmodif']){
$sql1p = "SELECT * FROM q1 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq1' size='50' value='".$q1cp."'><br>";
...
if($_POST['paysmodif']){
$sql2p = "SELECT * FROM q2 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql3p = "SELECT * FROM q3 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq3' size='50' value='".$q3cp."'><br>\n";
...
if($_POST['paysmodif']){
$sql4p = "SELECT * FROM q4 WHERE pays='$pays' ORDER BY id DESC";
...
echo "<br>Comments : <input type='text' name='commentq4' size='50' value='".$q4cp."'><br>";
...
if($_POST['paysmodif']){
$sql5p = "SELECT * FROM q5 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql6p = "SELECT * FROM q6 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq6' size='50' value='".$q6cp."'><br>";
...
if($_POST['paysmodif']){
$sql7p = "SELECT * FROM q7 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql8p = "SELECT * FROM q8 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql9p = "SELECT * FROM q9 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq9' size='50' value='".$q9cp."'><br>";
...
if($_POST['paysmodif']){
$sql10p = "SELECT * FROM q10 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq10' size='50' value='".$q10cp."'><br>";
...
if($_POST['paysmodif']){
$sql11p = "SELECT * FROM q11 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq11' size='50' value='".$q11cp."'><br>";
...
if($_POST['paysmodif']){
$sql12p = "SELECT * FROM q12 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq12' size='50' value='".$q12cp."'><br>";
...
if($_POST['paysmodif']){
$sql13p = "SELECT * FROM q13 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq13' size='50' value='".$q13cp."'><br>";
...
if($_POST['paysmodif']){
$sql14p = "SELECT * FROM q14 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq14' size='50' value='".$q14cp."'><br>";
...
if($_POST['paysmodif']){
$sql15p = "SELECT * FROM q15 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq15' size='50' value='".$q15cp."'><br>";
...
if($_POST['paysmodif']){
$sql16p = "SELECT * FROM q16 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq16' size='50' value='".$q16cp."'><br>";
...
if($_POST['paysmodif']){
$sql17p = "SELECT * FROM q17 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq17' size='50' value='".$q17cp."'><br>";
...
if($_POST['paysmodif']){
$sql18p = "SELECT * FROM q18 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq18' size='50' value='".$q18cp."'><br>";
...
if($_POST['paysmodif']){
$sql19p = "SELECT * FROM q19 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq19' size='50' value='".$q19cp."'><br>";
...
if($_POST['paysmodif']){
$sql20p = "SELECT * FROM q20 WHERE pays='$pays' ORDER BY id DESC";
...
echo "<br>Comments : <input type='text' name='commentq20' size='50' value='".$q20cp."'><br>";
...
if($_POST['paysmodif']){
$sql21p = "SELECT * FROM q21 WHERE pays='$pays' ORDER BY id DESC";
...
echo "<br>Comments : <input type='text' name='commentq21' size='50' value='".$q21cp."'><br>";
...
$sql22p = "SELECT * FROM q22 WHERE pays='$pays' ORDER BY id DESC";
$req22p = mysql_query($sql22p) or die("req22p : ".mysql_error());
$res22p = mysql_num_rows($req22p);
if($res22p>"0"){
$q22r = mysql_result($req22p,"0","q22r");
if ($q22r!=""){echo "Document : <a href='/pays/docpays/$q22r'>$q22r</a><br><br>";}
}else{echo "No document attached.";}
...
if($_POST['paysmodif']){
$sql23p = "SELECT * FROM q23 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql24p = "SELECT * FROM q24 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql25p = "SELECT * FROM q25 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql26p = "SELECT * FROM q26 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql271p = "SELECT * FROM q27q$i WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql28p = "SELECT * FROM q28 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq28' size='50' value='".$q28cp."'><br>\n";
...
if($_POST['paysmodif']){
$sql29p = "SELECT * FROM q29 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq29' size='50' value='".$q29cp."'><br>\n";
...
if($_POST['paysmodif']){
$sql30p = "SELECT * FROM q30 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq30' size='50' value='".$q30cp."'><br>\n";
...
if($_POST['paysmodif']){
$sql31p = "SELECT * FROM q31 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq31' size='50' value='".$q31cp."'><br>";
...
if($_POST['paysmodif']){
$sql32p = "SELECT * FROM q32 WHERE pays='$pays' ORDER BY id DESC";
...
.$q32r5sp."'><br>";
echo "Comments : <input type='text' name='commentq32' size='50' value='".$q32cp."'><br>";
...
if($_POST['paysmodif']){
$sql33p = "SELECT * FROM q33 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq33' size='50' value='".$q33cp."'><br>";
...
if($_POST['paysmodif']){
$sql34p = "SELECT * FROM q34 WHERE pays='$pays' ORDER BY id DESC";
...
echo "<br>Comments : <input type='text' name='commentq34' size='50' value='".$q34cp."'><br>";
...
if($_POST['paysmodif']){
$sql351p = "SELECT * FROM q35q$i WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql351c = "SELECT * FROM q35 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql36p = "SELECT * FROM q36 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql371p = "SELECT * FROM q37q$i WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql371c = "SELECT * FROM q37 WHERE pays='$pays' ORDER BY id DESC";
...
if($_POST['paysmodif']){
$sql38p = "SELECT * FROM q38 WHERE pays='$pays' ORDER BY id DESC";
...
echo "<br>Comments : <input type='text' name='commentq38' size='50' value='".$q38cp."'><br>";
...
if($_POST['paysmodif']){
$sql39p = "SELECT * FROM q39 WHERE pays='$pays' ORDER BY id DESC";
...
echo "Comments : <input type='text' name='commentq39' size='50' value='".$q39cp."'><br>";
...
if($_POST['paysmodif']){
$sql40p = "SELECT * FROM q40 WHERE pays='$pays' ORDER BY id DESC";
...
echo "<br>Comments : <input type='text' name='commentq40' size='50' value='".$q40cp."'><br>";
...
if($_POST['paysmodif']){
$sql41p = "SELECT * FROM q41 WHERE pays='$pays' ORDER BY id DESC";
