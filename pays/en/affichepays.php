...
$htmlresult .=  "<label>Country :</label> <select name='pays'>";
$htmlresult .=  "<option value=''>- s&eacute;lection -</option>";
$sql0 = "SELECT distinctrow pays FROM q1 WHERE pays!='non' ORDER BY pays";
...
$htmlresult .=  "</select>";
$htmlresult .=  "<input type='submit' value='Select this country'>";
$htmlresult .=  "</form>";
$htmlresult .=  "</div>";

$htmlresult .=  "<div class='form_select'>";
$htmlresult .=  "<form action='' method='POST'>";
$htmlresult .=  "<label>Question :</label> <select name='question'>";
$htmlresult .=  "<option value=''>- s&eacute;lection -</option>";
for($i=1;$i<="41";$i++){
$sql01 = "SELECT * FROM q$i WHERE pays='non'";
...
$htmlresult .=  "</select>";
$htmlresult .=  "<input type='submit' value='Select this question'>";
$htmlresult .=  "</form>";
$htmlresult .=  "</div>";
...
if($_POST['question']){
	...
	$sql02 = "SELECT distinctrow pays FROM $question WHERE pays!='non' ORDER BY pays"; //$htmlresult .=  $sql01;
	if($idquestion=="27")$sql02 = "SELECT distinctrow pays FROM q27q1 WHERE pays!='non' ORDER BY pays";
	...
	if($idquestion=="1"){
	$sql1 = "SELECT * FROM q1 WHERE pays='$row->pays' ORDER BY id DESC"; //$htmlresult .=  $sql01;
	...
	$q1c = mysql_result($req1,"0","comment");if ($q1c!="")$htmlresult .=  "Comments : $q1c<br>";
	}
	
	if($idquestion=="2"){
	$sql2 = "SELECT * FROM q2 WHERE pays='non'";
	...
	$sql2 = "SELECT * FROM q2 WHERE pays='$row->pays' ORDER BY id DESC"; //$htmlresult .=  $sql01;
	$req2 = mysql_query($sql2) or die("req2 : ".mysql_error());
	...
	if($idquestion=="3"){
	$sql3 = "SELECT * FROM q3 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q3c!="")$htmlresult .=  "Comments : $q3c<br>";
	}
	
	if($idquestion=="4"){
	$sql4 = "SELECT * FROM q4 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q4c!="")$htmlresult .=  "Comments : $q4c<br>";
	}
	
	if($idquestion=="5"){
	$sql5 = "SELECT * FROM q5 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="6"){
	$sql6 = "SELECT * FROM q6 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q6c!="")$htmlresult .=  "Comments : $q6c<br>";
	}
	
	if($idquestion=="7"){
	$sql7 = "SELECT * FROM q7 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="8"){
	$sql8 = "SELECT * FROM q8 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="9"){
	$sql9 = "SELECT * FROM q9 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q9c!="")$htmlresult .=  "Comments : $q9c<br>";
	}
	
	if($idquestion=="10"){
	$sql10 = "SELECT * FROM q10 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="11"){
	$sql11 = "SELECT * FROM q11 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q11c!="")$htmlresult .=  "Comments : $q11c<br>";
	}
	
	if($idquestion=="12"){
	$sql12 = "SELECT * FROM q12 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="13"){
	$sql13 = "SELECT * FROM q13 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="14"){
	$sql14 = "SELECT * FROM q14 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q14c!="")$htmlresult .=  "Comments : $q14c<br>";
	}
	
	if($idquestion=="15"){
	$sql15 = "SELECT * FROM q15 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q15c!="")$htmlresult .=  "Comments : $q15c<br>";
	}
	
	if($idquestion=="16"){
	$sql16 = "SELECT * FROM q16 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q16c!="")$htmlresult .=  "Comments : $q16c<br>";
	}
	
	if($idquestion=="17"){
	$sql17 = "SELECT * FROM q17 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q17c!="")$htmlresult .=  "Comments : $q17c<br>";
	}
	
	if($idquestion=="18"){
	$sql18 = "SELECT * FROM q18 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="19"){
	$sql19 = "SELECT * FROM q19 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="20"){
	$sql20 = "SELECT * FROM q20 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q20c!="")$htmlresult .=  "Comments : $q20c<br>";
	}
	
	if($idquestion=="21"){
	$sql21 = "SELECT * FROM q21 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q21c!="")$htmlresult .=  "Comments : $q21c<br>";
	}
	
	if($idquestion=="22"){
	$sql22 = "SELECT * FROM q22 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	}else{$htmlresult .=  "No document attached.";}
	}
	...
	$sql23 = "SELECT * FROM q23 WHERE pays='$row->pays' ORDER BY id DESC";
	$req23 = mysql_query($sql23) or die("req23 : ".mysql_error());
	...
	$sql24 = "SELECT * FROM q24 WHERE pays='$row->pays' ORDER BY id DESC";
	$req24 = mysql_query($sql24) or die("req24 : ".mysql_error());
	...
	$sql25 = "SELECT * FROM q25 WHERE pays='$row->pays' ORDER BY id DESC";
	$req25 = mysql_query($sql25) or die("req25 : ".mysql_error());
	...
	$sql26 = "SELECT * FROM q26 WHERE pays='$row->pays' ORDER BY id DESC";
	$req26 = mysql_query($sql26) or die("req26 : ".mysql_error());
	...
	$sql270 = "SELECT * FROM q27q$i WHERE pays='non' ORDER BY id DESC";
	$req270 = mysql_query($sql270) or die("req270 : ".mysql_error());
	$q27q[$i] = mysql_result($req270,"0","q27q$i");

	$sql271 = "SELECT * FROM q27q$i WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="28"){
	$sql28 = "SELECT * FROM q28 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q28c!="")$htmlresult .=  "Comments : $q28c<br>";
	}
	
	if($idquestion=="29"){
	$sql29 = "SELECT * FROM q29 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q29c!="")$htmlresult .=  "Comments : $q29c<br>";
	}
	
	if($idquestion=="30"){
	$sql30 = "SELECT * FROM q30 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q30c!="")$htmlresult .=  "Comments : $q30c<br>";
	}
	
	if($idquestion=="31"){
	$sql31 = "SELECT * FROM q31 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q31c!="")$htmlresult .=  "Comments : $q31c<br>";
	}
	
	if($idquestion=="32"){
	$sql32 = "SELECT * FROM q32 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q32c!="")$htmlresult .=  "Comments : $q32c<br>";
	}
	
	if($idquestion=="33"){
	$sql33 = "SELECT * FROM q33 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q33c!="")$htmlresult .=  "Comments : $q33c<br>";
	}
	
	if($idquestion=="34"){
	$sql34 = "SELECT * FROM q34 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q34c!="")$htmlresult .=  "Comments : $q34c<br>";
	}
	...
	$sql350 = "SELECT * FROM q35q$i WHERE pays='non' ORDER BY id DESC";
	$req350 = mysql_query($sql350) or die("req350 : ".mysql_error());
	$q35q[$i] = mysql_result($req350,"0","q35q$i");

	$sql351 = "SELECT * FROM q35q$i WHERE pays='$row->pays' ORDER BY id DESC";
	...
	$sql36 = "SELECT * FROM q36 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	for($i=1;$i<="5";$i++){ // boucle sur les 5 questions en BDD
	$sql370 = "SELECT * FROM q37q$i WHERE pays='non' ORDER BY id DESC";
	$req370 = mysql_query($sql370) or die("req370 : ".mysql_error());
	$q37q[$i] = mysql_result($req370,"0","q37q$i");

	$sql371 = "SELECT * FROM q37q$i WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if($idquestion=="38"){
	$sql38 = "SELECT * FROM q38 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q38c!="")$htmlresult .=  "Comments : $q38c<br>";
	}
	
	if($idquestion=="39"){
	$sql39 = "SELECT * FROM q39 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q39c!="")$htmlresult .=  "Comments : $q39c<br>";
	}
	
	if($idquestion=="40"){
	$sql40 = "SELECT * FROM q40 WHERE pays='$row->pays' ORDER BY id DESC";
	...
	if ($q40c!="")$htmlresult .=  "Comments : $q40c<br>";
	}
	
	if($idquestion=="41"){
	$sql41 = "SELECT * FROM q41 WHERE pays='$row->pays' ORDER BY id DESC";
...
$sql1 = "SELECT * FROM q1 WHERE pays='$pays' ORDER BY id DESC";
$req1 = mysql_query($sql1) or die("req1 : ".mysql_error());
...
if ($q1c!="")$htmlresult .=  "Comments : $q1c<br>";
$htmlresult .=  "<hr>";
...
$sql2 = "SELECT * FROM q2 WHERE pays='$pays' ORDER BY id DESC";
$req2 = mysql_query($sql2) or die("req2 : ".mysql_error());
$q2r1 = mysql_result($req2,"0","q2r1");
$q2r2 = mysql_result($req2,"0","q2r2");
$q2r3 = mysql_result($req2,"0","q2r3");
...
$sql3 = "SELECT * FROM q3 WHERE pays='$pays' ORDER BY id DESC";
$req3 = mysql_query($sql3) or die("req3 : ".mysql_error());
$q3r = mysql_result($req3,"0","q3r");
$q3c = mysql_result($req3,"0","comment");
if ($q3r!="")$htmlresult .=  "$q3r<br>";
...
$sql4 = "SELECT * FROM q4 WHERE pays='$pays' ORDER BY id DESC";
$req4 = mysql_query($sql4) or die("req4 : ".mysql_error());
$q4r = mysql_result($req4,"0","q4r");
$q4c = mysql_result($req4,"0","comment");
if ($q4r!="")$htmlresult .=  "$q4r<br>";
...
$sql5 = "SELECT * FROM q5 WHERE pays='$pays' ORDER BY id DESC";
$req5 = mysql_query($sql5) or die("req5 : ".mysql_error());
$q5r = mysql_result($req5,"0","q5r");
if ($q5r!="")$htmlresult .=  "$q5r<br>";
$htmlresult .=  "<hr>";
...
$sql6 = "SELECT * FROM q6 WHERE pays='$pays' ORDER BY id DESC";
$req6 = mysql_query($sql6) or die("req6 : ".mysql_error());
$q6r = mysql_result($req6,"0","q6r");
$q6c = mysql_result($req6,"0","comment");
if ($q6r!="")$htmlresult .=  "$q6r<br>";
...
$sql7 = "SELECT * FROM q7 WHERE pays='$pays' ORDER BY id DESC";
$req7 = mysql_query($sql7) or die("req7 : ".mysql_error());
$q7r = mysql_result($req7,"0","q7r");
if ($q7r!="")$htmlresult .=  "$q7r<br>";
$htmlresult .=  "<hr>";
...
$sql8 = "SELECT * FROM q8 WHERE pays='$pays' ORDER BY id DESC";
$req8 = mysql_query($sql8) or die("req8 : ".mysql_error());
$q8r = mysql_result($req8,"0","q8r");
if ($q8r!="")$htmlresult .=  "$q8r<br>";
$htmlresult .=  "<hr>";
...
$sql9 = "SELECT * FROM q9 WHERE pays='$pays' ORDER BY id DESC";
$req9 = mysql_query($sql9) or die("req9 : ".mysql_error());
...
$sql10 = "SELECT * FROM q10 WHERE pays='$pays' ORDER BY id DESC";
$req10 = mysql_query($sql10) or die("req10 : ".mysql_error());
$q10r1 = mysql_result($req10,"0","q10r1");
$q10r2 = mysql_result($req10,"0","q10r2");
$q10r3 = mysql_result($req10,"0","q10r3");
...
$sql11 = "SELECT * FROM q11 WHERE pays='$pays' ORDER BY id DESC";
$req11 = mysql_query($sql11) or die("req11 : ".mysql_error());
$q11r = mysql_result($req11,"0","q11r");
$q11c = mysql_result($req11,"0","comment");
if ($q11r!="")$htmlresult .=  "$q11r<br>";
...
$sql12 = "SELECT * FROM q12 WHERE pays='$pays' ORDER BY id DESC";
$req12 = mysql_query($sql12) or die("req12 : ".mysql_error());
$q12r1 = mysql_result($req12,"0","q12r1");
$q12r2 = mysql_result($req12,"0","q12r2");
$q12r3 = mysql_result($req12,"0","q12r3");
...
$sql13 = "SELECT * FROM q13 WHERE pays='$pays' ORDER BY id DESC";
$req13 = mysql_query($sql13) or die("req13 : ".mysql_error());
$q13r1 = mysql_result($req13,"0","q13r1");
$q13r2 = mysql_result($req13,"0","q13r2");
$q13r2s = mysql_result($req13,"0","q13r2s");
...
$sql14 = "SELECT * FROM q14 WHERE pays='$pays' ORDER BY id DESC";
$req14 = mysql_query($sql14) or die("req14 : ".mysql_error());
$q14r = mysql_result($req14,"0","q14r");
$q14c = mysql_result($req14,"0","comment");
if ($q14r!="")$htmlresult .=  "$q14r<br>";
...
$sql15 = "SELECT * FROM q15 WHERE pays='$pays' ORDER BY id DESC";
$req15 = mysql_query($sql15) or die("req15 : ".mysql_error());
$q15r = mysql_result($req15,"0","q15r");
$q15c = mysql_result($req15,"0","comment");
if ($q15r!="")$htmlresult .=  "$q15r<br>";
...
$sql16 = "SELECT * FROM q16 WHERE pays='$pays' ORDER BY id DESC";
$req16 = mysql_query($sql16) or die("req16 : ".mysql_error());
$q16r = mysql_result($req16,"0","q16r");
$q16c = mysql_result($req16,"0","comment");
if ($q16r!="")$htmlresult .=  "$q16r<br>";
...
$sql17 = "SELECT * FROM q17 WHERE pays='$pays' ORDER BY id DESC";
$req17 = mysql_query($sql17) or die("req17 : ".mysql_error());
$q17r = mysql_result($req17,"0","q17r");
$q17c = mysql_result($req17,"0","comment");
if ($q17r!="")$htmlresult .=  "$q17r<br>";
...
$sql18 = "SELECT * FROM q18 WHERE pays='$pays' ORDER BY id DESC";
$req18 = mysql_query($sql18) or die("req18 : ".mysql_error());
$q18r1 = mysql_result($req18,"0","q18r1");
$q18r1s = mysql_result($req18,"0","q18r1s");
$q18r2 = mysql_result($req18,"0","q18r2");
...
$sql19 = "SELECT * FROM q19 WHERE pays='$pays' ORDER BY id DESC";
$req19 = mysql_query($sql19) or die("req19 : ".mysql_error());
$q19r1 = mysql_result($req19,"0","q19r1");
$q19r1s = mysql_result($req19,"0","q19r1s");
$q19r2 = mysql_result($req19,"0","q19r2");
...
$sql20 = "SELECT * FROM q20 WHERE pays='$pays' ORDER BY id DESC";
$req20 = mysql_query($sql20) or die("req20 : ".mysql_error());
$q20r = mysql_result($req20,"0","q20r");
$q20c = mysql_result($req20,"0","comment");
if ($q20r!="")$htmlresult .=  "$q20r<br>";
...
$sql21 = "SELECT * FROM q21 WHERE pays='$pays' ORDER BY id DESC";
$req21 = mysql_query($sql21) or die("req21 : ".mysql_error());
$q21r = mysql_result($req21,"0","q21r");
$q21c = mysql_result($req21,"0","comment");
if ($q21r!="")$htmlresult .=  "$q21r<br>";
...
$sql22 = "SELECT * FROM q22 WHERE pays='$pays' ORDER BY id DESC";
$req22 = mysql_query($sql22) or die("req22 : ".mysql_error());
$res22 = mysql_num_rows($req22);
if($res22>"0"){
$q22r = mysql_result($req22,"0","q22r");
...
$sql23 = "SELECT * FROM q23 WHERE pays='$pays' ORDER BY id DESC";
$req23 = mysql_query($sql23) or die("req23 : ".mysql_error());
$q23r1 = mysql_result($req23,"0","q23r1");
$q23r2 = mysql_result($req23,"0","q23r2");
$q23r3 = mysql_result($req23,"0","q23r3");
...
$sql24 = "SELECT * FROM q24 WHERE pays='$pays' ORDER BY id DESC";
$req24 = mysql_query($sql24) or die("req24 : ".mysql_error());
$q24r1 = mysql_result($req24,"0","q24r1");
$q24r2 = mysql_result($req24,"0","q24r2");
$q24r3 = mysql_result($req24,"0","q24r3");
...
$sql25 = "SELECT * FROM q25 WHERE pays='$pays' ORDER BY id DESC";
$req25 = mysql_query($sql25) or die("req25 : ".mysql_error());
$q25r1 = mysql_result($req25,"0","q25r1");
$q25r2 = mysql_result($req25,"0","q25r2");
$q25r3 = mysql_result($req25,"0","q25r3");
...
$sql26 = "SELECT * FROM q26 WHERE pays='$pays' ORDER BY id DESC";
$req26 = mysql_query($sql26) or die("req26 : ".mysql_error());
$q26r1 = mysql_result($req26,"0","q26r1");
$q26r2 = mysql_result($req26,"0","q26r2");
$q26r3 = mysql_result($req26,"0","q26r3");
...
$sql271 = "SELECT * FROM q27q$i WHERE pays='$pays' ORDER BY id DESC";
$req271 = mysql_query($sql271) or die("req271 : ".mysql_error());
$q27qir = "q27q".$i."r";$q27qr[$i] = mysql_result($req271,"0","$q27qir");
$htmlresult .=  "<tr>\n";
$htmlresult .=  "<td>$q27q[$i]</td>\n";
...
$sql28 = "SELECT * FROM q28 WHERE pays='$pays' ORDER BY id DESC";
$req28 = mysql_query($sql28) or die("req28 : ".mysql_error());
$q28r1 = mysql_result($req28,"0","q28r1");
$q28r2 = mysql_result($req28,"0","q28r2");
$q28r3 = mysql_result($req28,"0","q28r3");
...
$sql29 = "SELECT * FROM q29 WHERE pays='$pays' ORDER BY id DESC";
$req29 = mysql_query($sql29) or die("req29 : ".mysql_error());
$q29r = mysql_result($req29,"0","q29r");
$q29c = mysql_result($req29,"0","comment");
if ($q29r!="")$htmlresult .=  "$q29r<br>";
...
$sql30 = "SELECT * FROM q30 WHERE pays='$pays' ORDER BY id DESC";
$req30 = mysql_query($sql30) or die("req30 : ".mysql_error());
$q30r = mysql_result($req30,"0","q30r");
$q30c = mysql_result($req30,"0","comment");
if ($q30r!="")$htmlresult .=  "$q30r<br>";
...
$sql31 = "SELECT * FROM q31 WHERE pays='$pays' ORDER BY id DESC";
$req31 = mysql_query($sql31) or die("req31 : ".mysql_error());
$q31r = mysql_result($req31,"0","q31r");
$q31c = mysql_result($req31,"0","comment");
if ($q31r!="")$htmlresult .=  "$q31r<br>";
...
$sql32 = "SELECT * FROM q32 WHERE pays='$pays' ORDER BY id DESC";
$req32 = mysql_query($sql32) or die("req32 : ".mysql_error());
$q32r1 = mysql_result($req32,"0","q32r1");
$q32r2 = mysql_result($req32,"0","q32r2");
$q32r3 = mysql_result($req32,"0","q32r3");
...
$sql33 = "SELECT * FROM q33 WHERE pays='$pays' ORDER BY id DESC";
$req33 = mysql_query($sql33) or die("req33 : ".mysql_error());
$q33r1 = mysql_result($req33,"0","q33r1");
$q33r1s = mysql_result($req33,"0","q33r1s");
$q33r2 = mysql_result($req33,"0","q33r2");
...
$sql34 = "SELECT * FROM q34 WHERE pays='$pays' ORDER BY id DESC";
$req34 = mysql_query($sql34) or die("req34 : ".mysql_error());
$q34r = mysql_result($req34,"0","q34r");
$q34c = mysql_result($req34,"0","comment");
if ($q34r!="")$htmlresult .=  "$q34r<br>";
...
$sql351 = "SELECT * FROM q35q$i WHERE pays='$pays' ORDER BY id DESC";
$req351 = mysql_query($sql351) or die("req351 : ".mysql_error());
$q35qir = "q35q".$i."r";$q35qr[$i] = mysql_result($req351,"0","$q35qir");
$q35qic = "q35q".$i."c";$q35qc[$i] = mysql_result($req351,"0","$q35qic");
$htmlresult .=  "<tr>\n";
...
$sql36 = "SELECT * FROM q36 WHERE pays='$pays' ORDER BY id DESC";
$req36 = mysql_query($sql36) or die("req36 : ".mysql_error());
$q36r1 = mysql_result($req36,"0","q36r1");$q36r1s = mysql_result($req36,"0","q36r1s");
$q36r2 = mysql_result($req36,"0","q36r2");$q36r2s = mysql_result($req36,"0","q36r2s");
$q36r3 = mysql_result($req36,"0","q36r3");$q36r3s = mysql_result($req36,"0","q36r3s");
...
$sql371 = "SELECT * FROM q37q$i WHERE pays='$pays' ORDER BY id DESC";
$req371 = mysql_query($sql371) or die("req371 : ".mysql_error());
$q37qir = "q37q".$i."r";$q37qr[$i] = mysql_result($req371,"0","$q37qir");
$q37qic = "q37q".$i."c";$q37qc[$i] = mysql_result($req371,"0","$q37qic");
$htmlresult .=  "<tr>\n";
...
$sql38 = "SELECT * FROM q38 WHERE pays='$pays' ORDER BY id DESC";
$req38 = mysql_query($sql38) or die("req38 : ".mysql_error());
$q38r = mysql_result($req38,"0","q38r");
$q38c = mysql_result($req38,"0","comment");
if ($q38r!="")$htmlresult .=  "$q38r<br>";
...
$sql39 = "SELECT * FROM q39 WHERE pays='$pays' ORDER BY id DESC";
$req39 = mysql_query($sql39) or die("req39 : ".mysql_error());
$q39r = mysql_result($req39,"0","q39r");
$q39r1r = mysql_result($req39,"0","q39r1r");
$q39c = mysql_result($req39,"0","comment");
...
$sql40 = "SELECT * FROM q40 WHERE pays='$pays' ORDER BY id DESC";
$req40 = mysql_query($sql40) or die("req40 : ".mysql_error());
$q40r = mysql_result($req40,"0","q40r");
$q40c = mysql_result($req40,"0","comment");
if ($q40r!="")$htmlresult .=  "$q40r<br>";
...
$sql41 = "SELECT * FROM q41 WHERE pays='$pays' ORDER BY id DESC";
$req41 = mysql_query($sql41) or die("req41 : ".mysql_error());
$q41r = mysql_result($req41,"0","q41r");
if ($q41r!="")$htmlresult .=  "$q41r<br>";
$htmlresult .=  "<hr>";
