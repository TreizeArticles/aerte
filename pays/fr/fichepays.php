...
if($_POST['pays']){
	...
	echo "<h3 style='color:green;'>Fiche pays $pays inseree.</h3>";
...
echo "Pays <input type='text' name='pays' size='50' value='".$_POST['pays']."'>";
echo "<hr>";
...
echo "Commentaires : <input type='text' name='commentq1' size='50' value='".$_POST['commentq1']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq3' size='50' value='".$_POST['commentq3']."'><br>\n";
...
echo "<br>Commentaires : <input type='text' name='commentq4' size='50' value='".$_POST['commentq4']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq6' size='50' value='".$_POST['commentq6']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq9' size='50' value='".$_POST['commentq9']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq10' size='50' value='".$_POST['commentq10']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq11' size='50' value='".$_POST['commentq11']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq12' size='50' value='".$_POST['commentq12']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq13' size='50' value='".$_POST['commentq13']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq14' size='50' value='".$_POST['commentq14']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq15' size='50' value='".$_POST['commentq15']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq16' size='50' value='".$_POST['commentq16']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq17' size='50' value='".$_POST['commentq17']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq18' size='50' value='".$_POST['commentq18']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq19' size='50' value='".$_POST['commentq19']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq20' size='50'  value='".$_POST['commentq20']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq21' size='50' value='".$_POST['commentq21']."'><br>";
...
echo "Si pas de competences partagees, merci de noter « pas de competences partagees » dans la premicre case.";
...
echo "Commentaires : <input type='text' name='commentq28' size='50' value='".$_POST['commentq28']."'><br>\n";
...
echo "Commentaires : <input type='text' name='commentq29' size='50' value='".$_POST['commentq29']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq30' size='50' value='".$_POST['commentq30']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq31' size='50' value='".$_POST['commentq31']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq32' size='50' value='".$_POST['commentq32']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq33' size='50'  value='".$_POST['commentq33']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq34' size='50' value='".$_POST['commentq34']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq38' size='50' value='".$_POST['commentq38']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq39' size='50' value='".$_POST['commentq39']."'><br>";
...
echo "Commentaires : <input type='text' name='commentq40' size='50' value='".$_POST['commentq40']."'><br>";
